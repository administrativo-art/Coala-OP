...
const prompt = ai.definePrompt({
  ...
  **Rules:**
  ...
  4.  **Work Schedule:** Assume a standard work pattern of 6 work days followed by 1 day off (6x1). Try to distribute the days off evenly throughout the month for all employees. A day off for an employee is represented by not having their name assigned to any shift on that day.
