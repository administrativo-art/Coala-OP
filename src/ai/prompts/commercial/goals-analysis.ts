...
export const goalsAnalysisPrompt = defineAiPrompt({
  id: "commercial.goals-analysis",
  module: "commercial",
  name: "Análise de metas comerciais",
  description: "Analisa ritmo, projeção, equipe, operação e risco de atingimento das metas.",
  version: "goals-analysis-v1",
  schemaVersion: "goals-analysis-v1",
  status: "active",
  risk: "medium",
  outputMode: "structured",
  owner: "Comercial",
  tags: ["metas", "vendas", "ritmo", "recomendação"],
  rulesBoundary: "A IA recomenda ações gerenciais. Metas, realizado e cálculos-base permanecem dados controlados pelo sistema.",
  render: () => `Você é o Diretor de Operações e Analista de Dados de uma rede de quiosques de shakes.
