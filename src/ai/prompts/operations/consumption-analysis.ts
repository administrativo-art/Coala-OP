...
export const consumptionAnalysisPrompt = defineAiPrompt({
  id: "operations.consumption-analysis",
  module: "operations",
  name: "Análise de consumo de insumos",
  description: "Diagnostica médias, séries e volatilidade de consumo por insumo e unidade.",
  version: "consumption-analysis-v1",
  schemaVersion: "consumption-analysis-v1",
  status: "active",
  risk: "low",
  outputMode: "structured",
  owner: "Operações",
  tags: ["consumo", "insumos", "diagnóstico"],
  rulesBoundary: "A IA produz diagnóstico. Não decide compras, reposições, transferências ou estoque mínimo.",
  render: () => `Você é um analista de dados especialista em análise de consumo para uma rede de quiosques de shakes.
