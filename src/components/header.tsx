...
const SECTION_MAP: Record<string, string> = {
  ...
  "/dashboard/financial/reconciliation": "Financeiro",
  "/dashboard/financial/reconciliation/receivables": "Financeiro",
  "/dashboard/financial/reconciliation/settlements": "Financeiro",
  "/dashboard/financial/reconciliation/integration": "Financeiro",
  "/dashboard/financial/reconciliation/closing": "Financeiro",
...
const LABEL_MAP: Record<string, string> = {
  ...
  "/dashboard/financial/reconciliation": "Conciliação",
  "/dashboard/financial/reconciliation/receivables": "Recebíveis Stone",
  "/dashboard/financial/reconciliation/settlements": "Liquidações Stone",
  "/dashboard/financial/reconciliation/integration": "Integração Stone",
  "/dashboard/financial/reconciliation/closing": "Fechamento mensal",
...
const SEARCH_ITEMS: { label: string; href: string; section: string }[] = [
  ...
  { label: "Conciliação", href: "/dashboard/financial/reconciliation", section: "Departamento financeiro" },
