...
const SECTION_MAP: Record<string, string> = {
  ...
  "/dashboard/dp/terminations": "Departamento pessoal",
  "/dashboard/hr/recruitment": "Departamento pessoal",
  "/dashboard/hr/recruitment/talents": "Departamento pessoal",
  "/dashboard/hr/recruitment/integration": "Departamento pessoal",
...
const SEARCH_ITEMS: { label: string; href: string; section: string }[] = [
  ...
  { label: "Desligamentos CLT", href: "/dashboard/dp/terminations", section: "Departamento pessoal" },
  ...
  { label: "Colaboradores", href: "/dashboard/dp/collaborators", section: "Departamento pessoal" },
