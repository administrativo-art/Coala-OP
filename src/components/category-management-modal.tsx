                ...
                <DialogContent className="max-w-3xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
                        ...
                        <div className="p-4 border rounded-lg">
                            <h3 className="font-semibold text-lg mb-4">{editingCategory ? "Editar Categoria" : "Nova Categoria"}</h3>
                            <Form {...form}>
                                        ...
                                        <div key={cat.id}>
                                            ...
                                            {categories.filter(sub => sub.parentId === cat.id).map(subCat => (
                                                <div key={subCat.id} className="flex items-center justify-between rounded-md border p-2 pl-6 ml-4 mt-1">
                                                     <div className="flex items-center gap-2">
                                                        <div className="h-4 w-4 rounded-full" style={{backgroundColor: subCat.color}}></div>
