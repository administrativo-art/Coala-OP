...
import { ProductManagement as AddEditProductModal } from './product-management';
...
export function ItemManagement() {
  ...
  return (
    <>
      ...
      <Card>
        <div className="p-6">
          <Button type="button" onClick={handleAddNewClick} className="w-full">
        ...
        {productsLoading || analysisProductsLoading || kiosksLoading ? (
          <div className="p-6 pt-0 space-y-4">
            ...
            <Skeleton className="h-12 w-full" />
              ...
              <div className="text-center py-8 text-muted-foreground p-6 pt-0">
                          ...
                          <RadixAccordion.Header className="flex w-full items-center p-4">
                              <RadixAccordion.Trigger className="flex flex-1 items-center justify-between text-left hover:no-underline font-semibold text-base px-0 py-0 [&[data-state=open]>svg]:rotate-180">
                                  <div>
                                    ...
                                    {analysisProduct && <p className="text-xs font-normal text-muted-foreground">Categoria: {analysisProduct.itemName}</p>}
                                  </div>
                                ...
                                render={({ field: pdfUnitField }) => {
                                  ...
                                  return (
                                    <FormItem className="pt-2">
                                      ...
                                      <FormDescription>
                                        Se a unidade no relatório de consumo for diferente da unidade da embalagem, especifique aqui para a conversão correta.
                                      </FormDescription>
                                      <FormMessage />
                                    </FormItem>
                                  )
