    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>{isEditing ? 'Editar lote' : 'Adicionar novo lote'}</DialogTitle>
            <DialogDescription>
              {isEditing ? 'Atualize as informações do lote.' : 'Preencha os detalhes do novo produto e do lote.'}
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
                ...
                <ScrollArea className="h-[60vh] pr-4">
                    <div className="space-y-4 py-4">
                        ...
                        <div className="p-4 border rounded-lg space-y-4">
                            <h4 className="text-sm font-medium text-muted-foreground">Detalhes do Lote</h4>
                            <FormField
                                control={form.control}
                                name="lotNumber"
                                render={({ field }) => (
