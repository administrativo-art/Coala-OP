...
type ActiveView = 'menu' | 'automatic' | 'manual' | 'history';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="flex flex-col text-center">
                <CardHeader>
                    ...
                    <CardDescription>Crie e gerencie pesquisas de preço manuais para cotações específicas.</CardDescription>
                </CardHeader>
                <CardContent className="flex-grow flex items-end justify-center">
                     <Button className="w-full" onClick={() => setActiveView('manual')}>
                        Acessar <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                </CardContent>
            </Card>
...
export function PurchaseManagement() {
    ...
    const getTitle = () => {
        switch (activeView) {
            ...
            case 'manual': return "Pesquisas Manuais";
