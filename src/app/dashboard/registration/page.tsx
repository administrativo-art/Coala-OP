...
import { ArrowRight, Package, Users, Box } from 'lucide-react';
import { useAuth } from '@/hooks/use-auth';

export default function RegistrationPage() {
    const { permissions } = useAuth();

    const canViewItems = permissions.registration.items.add || permissions.registration.items.edit || permissions.registration.items.delete;
    const canViewEntities = permissions.registration.entities.add || permissions.registration.entities.edit || permissions.registration.entities.delete;
