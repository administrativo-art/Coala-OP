    ...
    return (
        <div className="w-full">
            ...
            <div className="mb-6">
                ...
                <p className="text-muted-foreground">Selecione o tipo de contagem que deseja realizar.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 <Card className="flex flex-col">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2"><ShieldCheck /> Contagem de estoque</CardTitle>
                        <CardDescription>Inicie ou continue uma contagem de lotes de estoque em um quiosque.</CardDescription>
                    </CardHeader>
                     <CardContent className="flex-grow flex items-end">
                        <Link href="/dashboard/stock/audit/stock-audit" className="w-full">
                            <Button className="w-full">
                                Acessar contagem <ArrowRight className="ml-2" />
                            </Button>
                        </Link>
                    </CardContent>
                </Card>
