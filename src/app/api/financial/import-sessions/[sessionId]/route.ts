...
export async function PATCH(
  ...
  try {
    ...
    if (message === "RESULT_CENTER_NOT_FOUND") return jsonError("O centro de resultado selecionado não existe mais. Revise a classificação e confirme novamente a auditoria.", 409);
