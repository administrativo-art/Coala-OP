...
import { interCobrancaReadiness } from "@/lib/integrations/inter/config.server";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const [batches, adjustments, cobrancas] = await Promise.all([
