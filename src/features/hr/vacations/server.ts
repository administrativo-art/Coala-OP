  ...
  try {
    ...
    await financialDbAdmin.runTransaction(async (transaction) => {
      ...
      transaction.create(expenseRef, {
        ...
        referenceResultCenterId: prepared.user.unitId || null,
        referenceResultCenterName: resultCenter,
        resultCenter,
        resultCenterId: prepared.user.unitId || null,
        resultCenterName: resultCenter,
        totalValue: amount,
        competenceDate,
