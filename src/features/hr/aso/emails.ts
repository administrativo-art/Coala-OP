      ...
      (attachment, index) => `
        <tr><td style="padding-top:${index === 0 ? '0' : '8px'}">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #eee8ee;border-radius:12px;background:#fff">
            <tr>
              <td width="38" align="center" valign="middle" style="padding:11px 0 11px 10px">${renderEmailIconBox({ src: "https://op.coalashakes.com/email/icons/file-text-pink.png", iconSize: 14, boxSize: 28, background: "#fff0f6", radius: 8 })}</td>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#fffdfc;border-radius:25px;overflow:hidden;box-shadow:0 12px 30px rgba(44,34,62,.08)">
          ...
          <tr><td style="padding:22px 32px 0">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #b8e5ef;border-radius:17px;background:#e3f7fb">
              <tr>
                <td width="48" align="center" valign="middle" style="padding:17px 0 17px 16px">${renderEmailIconBox({ src: "https://op.coalashakes.com/email/icons/stethoscope-white.png", iconSize: 20, boxSize: 36, background: "#28b3d0", radius: 11 })}</td>
          ...
          <tr><td style="padding:22px 32px 0">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="32" align="center" valign="top">${renderEmailIconBox({ src: "https://op.coalashakes.com/email/icons/building-2-pink.png", iconSize: 14, boxSize: 28, background: "#fff0f6", radius: 9 })}</td>
          ...
          <tr><td style="padding:24px 32px 28px">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#fff1f7;border:1px solid #f7c8dc;border-radius:17px">
              <tr><td style="padding:19px 20px">
                ...
                <a href="${escapeHtml(input.replyUrl)}" style="display:inline-block;margin-top:14px;padding:13px 18px;border-radius:12px;background:#e92b86;color:#fff;text-decoration:none;font-size:12px;font-weight:900"><img src="https://op.coalashakes.com/email/icons/calendar-days-white.png" width="14" height="14" alt="" style="display:inline-block;vertical-align:-3px;border:0" />&nbsp; Informar data e horário</a>
              </td></tr>
            </table>
          </td></tr>
