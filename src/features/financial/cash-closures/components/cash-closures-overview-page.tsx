  ...
  return <PageContainer variant="default" className="max-w-[1320px] space-y-[18px] pb-10">
    ...
    {canViewClosures && !loading && sessions.length > 0 && <section className="space-y-3">
      ...
      {filteredSessions.length === 0
        ? <Card className="rounded-2xl border-stone-200"><CardContent className="grid min-h-24 w-full place-items-center !p-0 text-center text-sm text-muted-foreground">Nenhuma sessão neste filtro.</CardContent></Card>
