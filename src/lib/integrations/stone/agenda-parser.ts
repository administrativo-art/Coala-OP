...
const installment = z.object({
  ...
  AdvancedReceivableOriginalPaymentDate: optionalDate,
  AdvanceRateAmount: decimal.optional(),
    ...
    return (values === "" ? [] : values.Transaction).map((row) => {
      ...
      return {
        ...
        installments: installments.map((item) => ({
          ...
          advancedReceivableOriginalPaymentDate: civil(item.AdvancedReceivableOriginalPaymentDate),
          advanceRateAmount: item.AdvanceRateAmount ?? null,
