...
function productPayloadFromLookup(lookup: NormalizedProductData, overrides: Partial<Product> = {}) {
  ...
  return cleanUndefined({
    ...
    apparelType: overrides.apparelType,
    apparelSize: overrides.apparelSize,
    apparelColor: overrides.apparelColor,
    apparelFit: overrides.apparelFit,
    apparelMaterial: overrides.apparelMaterial,
    apparelUsage: overrides.apparelUsage,
    uniformCareInstructions: overrides.uniformCareInstructions,
