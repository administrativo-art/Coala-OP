...
O fluxo padrão não usa rede. A saída é exclusivamente local; a skill nunca altera manifest, lockfile, dependência, workflow ou configuração remota.
...
- Não faça commit, push, merge, deploy ou publicação automática.
