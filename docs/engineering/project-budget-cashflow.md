...
- Reenvio do mesmo vínculo/projeto/etapa é idempotente: retorna sucesso sem duplicar consumo, vínculo ou evento. Uma despesa já reservada por outro projeto continua sendo recusada.
