...
const expensesPage = readFileSync('src/features/financial/pages/expenses-page.tsx', 'utf8');
...
test('férias e despesas compartilham cabeçalho e escala tipográfica canônicos', () => {
