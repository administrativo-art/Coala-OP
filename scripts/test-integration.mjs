...
const child = spawn(
  ...
  [
    ...
    "--only",
    "firestore",
    "node --conditions=react-server --import tsx --test tests/integration/cash-closure-repository.test.mjs tests/integration/dp-day-off-publication.test.mjs tests/integration/pdv-sales-reconciliation.test.mjs tests/integration/financial-budgets.test.mjs",
  ],
