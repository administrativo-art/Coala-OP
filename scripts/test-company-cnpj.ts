...
const { CnpjValidator } = await import('../src/lib/company/cnpj-validator');
const { CompanyNormalizer } = await import('../src/lib/company/company-normalizer');
...
const brasilApiFixture: BrasilApiCnpj = {
  ...
  cep: '72546036',
  logradouro: 'Rua Ione Inacio de Brito',
  numero: 'LT 15',
...
console.log('company-cnpj basic tests passed');
